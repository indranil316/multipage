		...
		<header>
			<div class="container">
				<div class="fh5co-navbar-brand">
					<div class="row">
						<div class="col-xs-6">
							<h1 class="text-left"><a class="fh5co-logo" href="index.html"><span>Welcome</span> To <span>Our Website</span></a></h1>
						</div>
						<div class="col-xs-6">
			   			...
			   			<div class="col-md-8 col-md-offset-2 col-md-push-4 js-fullheight slider-text">
			   				<div class="slider-text-inner">
			   					<div class="desc">
				   					...
				   					<p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quasi rem, eum dolores tempora voluptas numquam.</p>
			   			...
			   			<div class="col-md-8 col-md-offset-2 col-md-push-4 js-fullheight slider-text">
			   				<div class="slider-text-inner">
			   					<div class="desc">
				   					...
				   					<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Magni quidem soluta impedit est ex quisquam!</p>
				   				</div>
			   				</div>
			   			</div>
			   		</div>
					...
					<div class="post-entry">
						...
						<div class="col-md-6 col-md-pull-5 animate-box">
							<div class="display-tc">
								<div class="desc">
									<span class="date">Jan 31, 2050</span>
									<h3>We love our students</h3>
									<p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Aperiam unde a temporibus harum alias cumque.</p>
								</div>
							</div>
						</div>
					</div>
