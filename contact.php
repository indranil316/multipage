			   			...
			   			<div class="col-md-8 col-md-offset-2 col-md-push-4 js-fullheight slider-text">
			   				<div class="slider-text-inner">
			   					<div class="desc">
			   						...
			   						<h2>Contact Us</h2>
			   						<p class="fh5co-lead">Designed with <i class="icon-heart3"></i> by  You</a></p>
			   					</div>
			   				</div>
			   			</div>
			   		</div>
				...
				<div class="row">
					<div class="col-md-3 col-md-push-1 animate-box">
						...
						<ul class="contact-info">
							...
							<li><i class="icon-phone2"></i>+ 1111111111</li>
							<li><i class="icon-mail"></i><a href="#">info@yoursitecom</a></li>
							<li><i class="icon-globe2"></i><a href="#">wwwyoursitecom</a></li>
						</ul>
					</div>
