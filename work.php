			   			...
			   			<div class="col-md-8 col-md-offset-2 col-md-push-4 js-fullheight slider-text">
			   				<div class="slider-text-inner">
			   					<div class="desc">
			   						...
			   						<h2>Our Work</h2>
			   						<p class="fh5co-lead">Designed with <i class="icon-heart3"></i> you</p>
			   					</div>
			   				</div>
			   			</div>
			   		</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-3">
							...
							<p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Odit aut, reiciendis natus sunt reprehenderit amet suscipit similique iste quas impedit..</p>
						</div>
